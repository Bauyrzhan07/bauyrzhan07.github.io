...
<body>
    ...
    <main class="content-list align">
        <nav class="flex-row justify">
            ...
            <a href="restaurants.html" class="flex-row active align">
        ...
        <div class="slider">
            ...
            <div class="flex-row">
                <a href="#" class="category-card scalable">
                    <img src="https://imageproxy.wolt.com/wolt-frontpage-images/categories/a69b5aea-c5a8-11ea-9f48-2e3b484a03e4_0b2c3eb5_ae95_4bff_9144_7f7c93ea74f9.jpg-md?w=600" >
                    <div class="category-card-bottom">
                        <p>Бургер</p>
                        <p class="category-place-count">91 мест</p>
                    </div>
                </a>
                <a href="#" class="category-card scalable">
                    <img src="https://imageproxy.wolt.com/wolt-frontpage-images/categories/fd1d18e0-c5a8-11ea-8a78-822e244794a0_a1852dc9_4afb_4877_9659_793adcb0f87b.jpg-md?w=600" >
                    <div class="category-card-bottom">
                        <p>Салаты</p>
                        <p class="category-place-count">145 мест</p>
                    </div>
                </a>
                <a href="#" class="category-card scalable">
                    <img src="https://imageproxy.wolt.com/wolt-frontpage-images/categories/53129366-c5a8-11ea-8a78-822e244794a0_52b897cd_ac18_4cb5_9921_2653f1d38650.jpg-md?w=600" >
                    <div class="category-card-bottom">
                        <p>Пицца</p>
                        <p class="category-place-count">140 мест</p>
                    </div>
                </a>
                <a href="#" class="category-card scalable">
                    <img src="https://imageproxy.wolt.com/wolt-frontpage-images/categories/7f77b0a2-c5a9-11ea-b72a-c2fc8785833c_57601b6c_2bf1_4240_a6d0_da0d7dca0517.jpg-md?w=600" >
                    <div class="category-card-bottom">
                        <p>Супы</p>
                        <p class="category-place-count">106 мест</p>
                    </div>
                </a>
                <a href="#" class="category-card scalable">
                    <img src="https://imageproxy.wolt.com/wolt-frontpage-images/categories/0a824832-c5b0-11ea-8a94-b2000c51ab5c_4b9cac02_a445_4de3_acf2_94398063345e.jpg-md?w=600" >
                    <div class="category-card-bottom">
                        <p>Американская</p>
                        <p class="category-place-count">57 мест</p>
                    </div>
                </a>
                <a href="#" class="category-card scalable">
                    <img src="https://imageproxy.wolt.com/wolt-frontpage-images/categories/5c379448-8364-11ec-86c9-f6b3c036ea5b_2fc5ac24_1974_4871_a73a_829e6417f3f9.jpeg-md?w=600" >
                    <div class="category-card-bottom">
                        <p>Курица</p>
                        <p class="category-place-count">49 мест</p>
                    </div>
                </a>
            </div>
        </div>
