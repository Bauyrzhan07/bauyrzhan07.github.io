<?php
    $currentPage = end(preg_split("/", $_SERVER['SCRIPT_NAME']));
    $discoveryClass = "flex-row align";
    $restaurantsClass = "flex-row align";
    $storesClass = "flex-row align";
    if($currentPage == 'discovery.php')
        $discoveryClass .= " active";
    if($currentPage == 'restaurants.php')
        $discoveryClass .= " active";
    if($currentPage == 'stores.php')
        $discoveryClass .= " active";
>

<nav class="flex-row justify">
    <a href="discovery.php" class=<?=$discoveryClass?>>
    ...
    <a href="restaurants.php" class=<?=$restaurantsClass?>>
    ...
    <a href="stores.php" class=<?=$storesClass?>>
